...
VALUES
  ('weekday-0',  'weekday', 0,  'Opstaan, klaarmaken',              0,   30,  'prep',             false, NULL,    NULL,    NOW(), NOW()),
  ('weekday-1',  'weekday', 1,  'Lezen',                            30,  90,  'reading',          false, NULL,    NULL,    NOW(), NOW()),
  ('weekday-2',  'weekday', 2,  'Verplaatsing naar universiteit',   90,  120, 'transit',          false, NULL,    NULL,    NOW(), NOW()),
  ('weekday-3',  'weekday', 3,  'Schrijven',                        120, 165, 'writing',          false, NULL,    NULL,    NOW(), NOW()),
  ('weekday-4',  'weekday', 4,  'Micro-pauze',                      165, 170, 'microbreak',       false, NULL,    NULL,    NOW(), NOW()),
  ('weekday-5',  'weekday', 5,  'Schrijven',                        170, 210, 'writing',          false, NULL,    NULL,    NOW(), NOW()),
  ('weekday-6',  'weekday', 6,  'Pauze',                            210, 225, 'break',            false, NULL,    NULL,    NOW(), NOW()),
  ('weekday-7',  'weekday', 7,  'Revisie',                          225, 270, 'revision',         false, NULL,    NULL,    NOW(), NOW()),
  ('weekday-8',  'weekday', 8,  'Micro-pauze',                      270, 275, 'microbreak',       false, NULL,    NULL,    NOW(), NOW()),
  ('weekday-9',  'weekday', 9,  'Revisie',                          275, 315, 'revision',         false, NULL,    NULL,    NOW(), NOW()),
  ('weekday-10', 'weekday', 10, 'Lunch + wandeling',                315, 360, 'lunch',            false, NULL,    NULL,    NOW(), NOW()),
  ('weekday-11', 'weekday', 11, 'Seminars / lopend werk',           360, 405, 'seminar_ongoing',  false, NULL,    NULL,    NOW(), NOW()),
  ('weekday-12', 'weekday', 12, 'Micro-pauze',                      405, 410, 'microbreak',       false, NULL,    NULL,    NOW(), NOW()),
  ...
  ('saturday-0', 'saturday', 0, 'Opstaan, klaarmaken',                                  0,   45,  'prep',    false, NULL, NULL, NOW(), NOW()),
  ('saturday-1', 'saturday', 1, 'Lezen',                                                45,  135, 'reading', false, NULL, NULL, NOW(), NOW()),
  ('saturday-2', 'saturday', 2, 'Weekboodschappen (flexibel, versleep naar wens)',      390, 450, 'errand',  false, NULL, NULL, NOW(), NOW()),

  ('sunday-0',   'sunday',   0, 'Opstaan, klaarmaken', 0,  30, 'prep',    false, NULL,    NULL,    NOW(), NOW()),
  ('sunday-1',   'sunday',   1, 'Lezen',               30, 90, 'reading', false, NULL,    NULL,    NOW(), NOW()),
